...
export const selectIsLoadingFlights = createSelector(featureSelector, (state) => state.isLoadingFlights);
export const selectLoadingFlightsError = createSelector(featureSelector, (state) => state.loadingFlightsError);
